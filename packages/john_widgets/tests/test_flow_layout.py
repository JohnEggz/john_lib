...
from john_widgets.flow_layout import FlowContainer
...
class TestWindow(QWidget):
    def __init__(self):
        ...
        self.flow_container = FlowContainer(min_height=100)
        
        main_layout.addWidget(self.flow_container)
        main_layout.addWidget(QPushButton(text="hello"))
    ...
    def toggle_grid(self, checked):
        self.flow_container.set_grid(checked, size=200)
